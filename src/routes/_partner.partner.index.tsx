    ...
    <div className="p-8 space-y-6">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">
            Welcome, {dash.partner.legal_company_name}
          </h1>
          <p className="text-sm text-slate-500">
            Partner ID <span className="font-mono">{dash.partner.partner_id}</span> · Territory{" "}
            {dash.partner.territory ?? "—"} · Commission {Number(dash.partner.commission_pct)}%
          </p>
        </div>
      ...
      <Card className="border border-slate-200 bg-white p-6 rounded-xl shadow-sm">
        ...
        <p className="mt-2 text-xs text-slate-500">
          Every client who signs up through this link is attributed to your Partner ID. Duplicate
          claims are automatically blocked.
        </p>
      </Card>
        ...
        <Card className="border border-slate-200 bg-white p-6 rounded-xl shadow-sm">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-slate-500">
              Creates a branded proposal PDF with your Partner ID and referral code included.
            </p>
          </div>
        </Card>
      </div>
      ...
      <Card className="border border-slate-200 bg-white p-6 rounded-xl shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/partner/clients" className="text-xs text-blue-600 hover:underline">
            View all →
          </Link>
        </div>
