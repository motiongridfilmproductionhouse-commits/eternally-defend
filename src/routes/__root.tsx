...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Eterna AI — Digital Protection" },
      { property: "og:description", content: "AI monitoring, copyright protection, and automated takedowns in one command center." },
