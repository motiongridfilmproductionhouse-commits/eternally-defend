  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <button className="size-7 grid place-items-center rounded-md text-muted-foreground hover:bg-white/60">
          <X className="size-4" />
        </button>
      </div>
      ...
      <div className="mt-4 space-y-2">
        {actions.map((a) => {
          ...
          return (
            <button
              key={a.label}
              className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl bg-white/70 hover:bg-white text-sm text-left transition"
            >
      ...
      <div className="mt-auto pt-4">
        <div className="relative">
          <input
            ...
            className="w-full pl-4 pr-11 py-3 rounded-2xl bg-white border border-border text-sm focus:outline-none focus:ring-2 focus:ring-primary/20"
          />
          <button
            className="absolute right-1.5 top-1/2 -translate-y-1/2 size-9 grid place-items-center rounded-xl text-white"
