import { Waypoints, useQueryClient } from "@tanstack/react-query";
          ...
          <Link to="/" className="flex items-center gap-3 min-w-0 flex-1">
            ...
            {!collapsed && (
              <div className="min-w-0">
                <div className="font-display font-bold text-[15px] leading-tight tracking-tight truncate">
                  Eterna AI
                </div>
                <div className="text-[9px] tracking-[0.22em] text-sidebar-foreground/60 font-semibold">
                  SECURITY CLOUD
                </div>
              </div>
            )}
        ...
        <div className="mt-auto space-y-3">
          {!collapsed && (
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, oklch(0.58 0.20 260 / 0.18), oklch(0.51 0.20 262 / 0.08))",
              }}
            >
              <div className="flex items-center gap-2.5">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-[10px] text-sidebar-foreground/70 uppercase tracking-wider">
                    Active
                  </div>
                </div>
              </div>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              className={`w-full rounded-xl p-2 pr-3 flex items-center gap-2.5 border border-sidebar-border/60 bg-sidebar-accent/20 hover:bg-sidebar-accent/50 transition text-left ${collapsed ? "justify-center pr-2" : ""}`}
            >
              {meta.avatar_url ? (
                <img
                  src={meta.avatar_url}
                ...
                <div
                  className="size-8 rounded-lg grid place-items-center text-white text-xs font-bold shrink-0"
                  style={{ background: "var(--gradient-brand)" }}
                >
                  {initial}
                </div>
