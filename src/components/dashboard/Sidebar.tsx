...
const nav = [
  ...
  { icon: ShieldCheck, label: "Enforcement" },
  { icon: Briefcase, label: "Case Management", badge: "2" },
  { icon: Trash2, label: "Removal Center" },
  ...
  return (
    <aside className="w-64 shrink-0 bg-sidebar border-r border-sidebar-border flex flex-col p-4 gap-4">
      ...
      <div className="mt-2">
        ...
        <button className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-sidebar-foreground hover:bg-sidebar-accent/60 w-full">
      ...
      <div className="mt-auto space-y-3">
        <div className="rounded-2xl p-4 border border-sidebar-border" style={{ background: "var(--gradient-soft)" }}>
          ...
          <button className="mt-3 w-full text-sm py-2 rounded-lg bg-white/70 hover:bg-white transition font-medium">View Plan</button>
        </div>
