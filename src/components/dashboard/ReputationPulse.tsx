    ...
    <div className="card-surface p-5">
          ...
          <div>
            ...
            <div className="h-1.5 rounded-full bg-secondary mt-1 overflow-hidden">
              <div
                ...
                style={{ width: "62%", background: "var(--gradient-brand)" }}
              />
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 mt-4 pt-4 border-t border-border">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-[11px] text-muted-foreground">Negative Trend</div>
            <div className="text-sm font-semibold text-rose-500">-14%</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <Heart className="size-4 text-rose-400" />
          <div>
            <div className="text-[11px] text-muted-foreground">Viral Velocity</div>
            <div className="text-sm font-semibold text-rose-500">High</div>
          </div>
        </div>
      </div>
    </div>
