...
const MOCK: Record<PlatformKey, Finding[]> = {
  youtube: [
    {
      id: "y1",
      title: "AI-generated deepfake impersonation compilation",
      author: "@ViralClipsHQ",
      thumbnail:
      ...
      type: "Deepfake",
      detectedAt: "2h ago",
      metrics: { views: "1.2M", likes: "48K", comments: "3.2K" },
      url: "#",
    },
    {
      id: "y2",
      title: "Unauthorized use of likeness in product promotion",
      author: "@TrendReviews",
      thumbnail:
      ...
      detectedAt: "5h ago",
      metrics: { views: "342K", likes: "12K", comments: "890" },
      url: "#",
    },
    {
      id: "y3",
      title: "Fabricated interview clip with synthetic voice",
      author: "@NewsMashup",
      thumbnail:
      ...
      type: "Voice Clone",
      detectedAt: "8h ago",
      metrics: { views: "89K", likes: "4.1K", comments: "512" },
      url: "#",
    },
    {
      id: "y4",
      title: "Face-swap montage on entertainment channel",
      author: "@EntertainDaily",
      thumbnail:
        "https://images.unsplash.com/photo-1493804714600-6edb1cd93080?w=400&h=225&fit=crop",
      severity: "medium",
      type: "Deepfake",
      detectedAt: "1d ago",
      metrics: { views: "56K", likes: "2.3K", comments: "180" },
      url: "#",
    },
    {
      id: "y5",
      title: "Misleading thumbnail using edited likeness",
      author: "@ClickbaitCentral",
      thumbnail:
        "https://images.unsplash.com/photo-1522542550221-31fd19575a2d?w=400&h=225&fit=crop",
      severity: "medium",
      type: "Misinformation",
      detectedAt: "1d ago",
      metrics: { views: "128K", likes: "5.9K", comments: "740" },
      url: "#",
    },
  ],
  instagram: [
    {
      id: "i1",
      title: "Reel featuring AI-generated likeness endorsement",
      author: "@luxe.deals",
      thumbnail:
        "https://images.unsplash.com/photo-1611162616475-46b635cb6868?w=400&h=400&fit=crop",
      severity: "critical",
      type: "Fake Endorsement",
      detectedAt: "1h ago",
      metrics: { views: "780K", likes: "62K", comments: "1.8K" },
      url: "#",
    },
    {
      id: "i2",
      title: "Impersonation account posing as verified profile",
      author: "@official.eterna.fake",
      thumbnail:
        "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400&h=400&fit=crop",
      severity: "high",
      type: "Impersonation",
      detectedAt: "3h ago",
      metrics: { likes: "8.4K", comments: "420" },
      url: "#",
    },
    {
      id: "i3",
      title: "Story highlight using unlicensed brand footage",
      author: "@stylefeed",
      thumbnail:
      ...
      type: "IP Violation",
      detectedAt: "6h ago",
      metrics: { views: "34K", likes: "1.9K" },
      url: "#",
    },
    {
      id: "i4",
      title: "Carousel post with edited likeness",
      author: "@fanpage.hub",
      thumbnail:
      ...
      type: "Unauthorized Usage",
      detectedAt: "1d ago",
      metrics: { likes: "3.2K", comments: "89" },
      url: "#",
    },
  ],
  tiktok: [
    {
      id: "t1",
      title: "Viral deepfake dance trend using synthetic likeness",
      author: "@dancewave",
      thumbnail:
        "https://images.unsplash.com/photo-1516251193007-45ef944ab0c6?w=400&h=600&fit=crop",
      severity: "high",
      type: "Deepfake",
      detectedAt: "4h ago",
      metrics: { views: "2.4M", likes: "180K", shares: "12K" },
      url: "#",
    },
    {
      id: "t2",
      title: "Voice clone in reaction sound trend",
      author: "@sounds.daily",
      thumbnail:
      ...
      type: "Voice Clone",
      detectedAt: "9h ago",
      metrics: { views: "410K", likes: "23K", shares: "1.4K" },
      url: "#",
    },
    {
      id: "t3",
      title: "Face-swap comedy skit",
      author: "@lol.factory",
      thumbnail:
      ...
      type: "Deepfake",
      detectedAt: "2d ago",
      metrics: { views: "88K", likes: "4.6K", shares: "310" },
      url: "#",
    },
  ],
  reddit: [
    {
      id: "r1",
      title: "Thread compiling AI-generated fake statements",
      author: "u/leaks_watcher",
      thumbnail:
        "https://images.unsplash.com/photo-1495020689067-958852a7765e?w=400&h=225&fit=crop",
      severity: "high",
      type: "Misinformation",
      detectedAt: "3h ago",
      metrics: { likes: "4.2K", comments: "820" },
      url: "#",
    },
    {
      id: "r2",
      title: "Cross-post of unauthorized deepfake to r/videos",
      author: "u/reposter",
      thumbnail:
        "https://images.unsplash.com/photo-1526628953301-3e589a6a8b74?w=400&h=225&fit=crop",
      severity: "medium",
      type: "Deepfake",
      detectedAt: "1d ago",
      metrics: { likes: "1.1K", comments: "230" },
      url: "#",
    },
  ],
  news: [
    {
      id: "n1",
      title: "Article citing fabricated quote as primary source",
      author: "dailyfeed.example.com",
      thumbnail:
    ...
    {
      id: "n2",
      title: "Opinion piece using AI-generated header image",
      author: "opinionwire.example.com",
      thumbnail:
  ...
  x: [
    {
      id: "x1",
      title: "Viral post with AI-generated screenshot of statement",
      author: "@breaking_hub",
      thumbnail:
      ...
      type: "Misinformation",
      detectedAt: "1h ago",
      metrics: { views: "1.8M", likes: "42K", shares: "18K" },
      url: "#",
    },
    {
      id: "x2",
      title: "Impersonation account with paid verification",
      author: "@eterna_ai_official",
      thumbnail:
        "https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=400&h=225&fit=crop",
      severity: "critical",
      type: "Impersonation",
      detectedAt: "5h ago",
      metrics: { views: "230K", likes: "9.1K" },
      url: "#",
    },
  ],
};
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <div className="text-xs text-muted-foreground/80">
              Findings by platform · click to view results
            </div>
          </div>
          <button
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-[11px] text-muted-foreground">
                    <span className="font-semibold text-foreground">{p.count}</span> Findings
                  </div>
                </div>
              </button>
            );
            ...
            <>
              <DialogHeader className="px-6 py-4 border-b border-border flex-row items-center gap-3 space-y-0">
                <div
                  ...
                  style={{
                    background: `color-mix(in oklab, ${activeItem.color} 18%, transparent)`,
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground">
                    {activeItem.count} findings detected · showing {findings.length}
                  </div>
                </div>
              </DialogHeader>
              ...
              <div className="overflow-y-auto p-5 bg-background/40">
                <div
                  className={`grid gap-4 ${active === "tiktok" || active === "instagram" ? "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3" : "grid-cols-1 md:grid-cols-2"}`}
                >
                  {findings.map((f) => (
...
function FindingCard({
  ...
  f: Finding;
  platform: { icon: any; name: string; color: string };
}) {
    ...
    <div className="rounded-xl border border-border bg-card overflow-hidden hover:shadow-md hover:border-primary/40 transition-all">
      <div className="relative aspect-video bg-muted overflow-hidden">
        ...
        <div className="absolute top-2 right-2">
          <div
            className="size-7 rounded-lg grid place-items-center backdrop-blur-md"
            style={{
              background: `color-mix(in oklab, ${platform.color} 25%, rgba(0,0,0,0.5))`,
              color: "#fff",
            }}
          >
        ...
        <div className="flex items-center gap-3 text-[11px] text-muted-foreground pt-1 border-t border-border">
          {f.metrics.views && (
            <span className="flex items-center gap-1">
              <Eye className="size-3" /> {f.metrics.views}
            </span>
          )}
          {f.metrics.likes && (
            <span className="flex items-center gap-1">
              <ThumbsUp className="size-3" /> {f.metrics.likes}
            </span>
          )}
          {f.metrics.comments && (
            <span className="flex items-center gap-1">
              <MessageSquare className="size-3" /> {f.metrics.comments}
            </span>
          )}
          {f.metrics.shares && (
            <span className="flex items-center gap-1">
              <ExternalLink className="size-3" /> {f.metrics.shares}
            </span>
          )}
        </div>
