  ...
  const handleGenerate = async (id: string) => {
    ...
    try {
      ...
      setActiveChallenges((prev) => ({
        ...prev,
        [id]: { code: chal.code, expiresAt: chal.expires_at },
      }));
      await refetch();
    } catch (e: any) {
    ...
    <Card className="bg-[#0A1128] border-white/10 text-white shadow-2xl shadow-black/50">
      <CardHeader>
        ...
        <CardDescription className="text-white/60">
          Add your YouTube channels. To prove ownership, we will provide a secure code for you to
          paste into your channel or video description.
        </CardDescription>
      </CardHeader>
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge
                        variant="outline"
                        className={`text-[10px] uppercase ${isVerified ? "border-emerald-500/30 text-emerald-400 bg-emerald-500/10" : "border-white/20 text-white/60 bg-white/5"}`}
                      >
                      ...
                      <div>
                        ...
                        <div className="text-xs space-y-0.5">
                          ...
                          <div>
                            ...
                            {asset.verification_method ?? "Channel Description"}
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      {chal ? (
                        <>
                          ...
                          <div className="flex gap-2">
                            ...
                            <Button
                              variant="secondary"
                              onClick={() => {
                                navigator.clipboard.writeText(chal.code);
                          ...
                          <div className="text-sm text-white/80">
                            <strong>Step 2:</strong> Paste the code into your{" "}
                            <a
                              href={asset.channel_url ?? undefined}
                              target="_blank"
                              rel="noreferrer"
                            ...
                            (About tab) or into the description of any of your 5 most recent public
                            videos.
                          </div>
                        ...
                        <div className="flex flex-col items-center justify-center py-2 space-y-3">
                          <p className="text-sm text-white/60 text-center">
                            Generate a secure code to place on your channel to verify ownership.
                          </p>
                          <Button
                            onClick={() => handleGenerate(asset.id)}
                            disabled={busy}
