    ...
    <Card className="border-white/10 bg-[#0A1128] text-white shadow-2xl">
      <CardHeader>
        ...
        <CardDescription className="text-white/60">
          Enter the legal details that will appear on authorization records and certificates.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-5">
        <div className="grid gap-4 md:grid-cols-2">
          <Field label={needsCompany ? "Authorized representative" : "Full legal name"} required>
            <Input
          ...
          <Field label={accountType === "celebrity" ? "Public / stage name" : "Display name"}>
            <Input
          ...
          {needsCompany && (
            <Field
              label={accountType === "production_house" ? "Production house name" : "Company name"}
              required
            >
              <Input
