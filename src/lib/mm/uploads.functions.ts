...
const RegisterInput = z.object({
  ...
  permission_confirmed: z.literal(true, {
    errorMap: () => ({
      message: "You must confirm you own or have lawful permission to process this file.",
    }),
  }),
...
const CaptionInput = z.object({
  ...
  transcript_source: z
    .enum(["user_uploaded", "owner_authorised", "stt", "manual", "external"])
