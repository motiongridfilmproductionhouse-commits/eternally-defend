...
const EU_COUNTRIES = new Set([
  "DE", "FR", "NL", "IE", "SE", "FI", "DK", "ES", "IT", "PL", "PT", "BE",
  "AT", "CZ", "RO", "BG", "GR", "HU", "SK", "SI", "HR", "LT", "LV", "EE",
  "LU", "MT", "CY",
]);
...
export function draftLegalNotice(intel: DomainIntel, workTitle: string): string {
  ...
  return [
    ...
    inv.embeddedPlayers.length ? `  • Embedded players observed: ${inv.embeddedPlayers.length}` : "",
    "",
...
const COUNTRY_COORDS: Record<string, [number, number]> = {
  ...
  GB: [-2, 54], IE: [-8, 53], FR: [2, 46], DE: [10, 51], NL: [5, 52],
  BE: [4, 50], ES: [-4, 40], PT: [-8, 39], IT: [12, 42], CH: [8, 47],
  SE: [15, 62], NO: [8, 61], FI: [26, 64], DK: [10, 56], PL: [19, 52],
  CZ: [15, 50], RO: [25, 46], BG: [25, 43], GR: [22, 39], UA: [32, 49],
  RU: [90, 61], TR: [35, 39], IL: [35, 31], AE: [54, 24], SA: [45, 24],
  IN: [79, 22], PK: [69, 30], BD: [90, 24], LK: [81, 7], CN: [104, 35],
  HK: [114, 22], TW: [121, 24], JP: [138, 36], KR: [128, 36], SG: [104, 1],
  MY: [102, 4], ID: [113, -1], TH: [101, 15], VN: [106, 16], PH: [122, 12],
  AU: [134, -25], NZ: [174, -41], ZA: [24, -29], NG: [8, 9], EG: [30, 26],
  KE: [38, 0], MA: [-6, 32], SC: [55, -4], PA: [-80, 9], BZ: [-88, 17],
  VG: [-64, 18], KY: [-81, 19], CY: [33, 35], MD: [28, 47], KZ: [67, 48],
};
